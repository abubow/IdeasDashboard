...
const Tabs = (props : Props) => {
    ...
    const TabsContent = [
        (
            <div className="tab tabs1">
                <h1 style={{ fontSize: "2rem", fontWeight: 500, marginBottom: "1.5rem" }}>
                    Titles are very important
                </h1>
                <p style={{ fontSize: "1rem", fontWeight: 100, marginBottom: "1.5rem",lineHeight: "1.5rem", textAlign: "justify", padding: "0 1rem" }}>
    ...
    const listContent = props.data.map((item, index) =>
        <p style={visibleTab === item.id ? {} : {display: 'none'}} key={index}>
