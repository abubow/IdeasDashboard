...
const ToggleSwitch = styled.div<ToggleProps>`
    ...
    max-height: 5vh;
    border-radius: 22px;
    background-color: ${props => props.colorTheme === 'light' ?  'rgba(28, 29, 34, 0.1)': 'rgba(255, 255, 255, 0.05)'};
...
const SwitchBall = styled.div<ToggleProps>`
    ...
    max-height: 4.5vh;
    border-radius: 22px;
    background-color: ${props => props.colorTheme === 'light' ? '#fff' : 'rgba(255, 255, 255, 0.05)'};
    transition: all 0.5s ease;
    padding: 1vh 1vw;
                        ...
                        <UnorderedList>
                            <OptionLi key={index}
                                ...
                                style={{ 
                                    ...
                                    fontWeight: optionSelected === option.name ? 600 : 400,
                                }}>
                                <Option>
                                    {option.name}
