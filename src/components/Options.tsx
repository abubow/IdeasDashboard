        ...
        <ToggleSwitch colorTheme={colorTheme}
         onClick={() => setColorTheme(colorTheme === 'light' ? 'dark' : 'light')}>
            ...
            <SwitchLabel style={{color: colorTheme === 'light' ? 'rgba(0, 0, 0, 1)' : 'rgba(255, 255, 255, 0.5)', transition: 'all 0.5s ease', zIndex: 2}}>
                ...
                <div style={{margin: '0 0.5rem', fontSize: '0.8rem', fontWeight: 500, color: colorTheme === 'light' ? 'rgba(0, 0, 0, 1)' : 'rgba(255, 255, 255, 0.5)'}}>
                    Light
                </div>
            </SwitchLabel>
            <SwitchLabel style={{opacity: colorTheme === 'light' ? 'rgba(0, 0, 0, 0.5)' : 'rgba(255, 255, 255, 1)', transition: 'all 0.5s ease',zIndex: 2}}>
                ...
                <div style={{margin: '0 0.5rem', fontSize: '0.8rem', fontWeight: 500, color: colorTheme === 'light' ? 'rgba(0, 0, 0, 0.5)' : 'rgba(255, 255, 255, 1)'}}>
                    Dark
                </div>
            </SwitchLabel>
         </ToggleSwitch>
